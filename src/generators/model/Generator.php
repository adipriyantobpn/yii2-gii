...
class Generator extends \yii\gii\Generator
{
     ...
     * @param array $relations relation-array which is originally generated by self::generateRelations()
     * @return array the re-ordered relation-array
     */
    public function sortRelation($relations)
    {
        $relKey = array_keys($relations);
        $relVal = array_values($relations);
        array_multisort($relVal, $relKey);
